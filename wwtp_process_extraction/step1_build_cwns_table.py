...
ca_wwtp_process_extraction = facility_permit[
...
required_ids = set(ca_wwtp_process_extraction['CWNS_ID'].astype(str).str.strip())
...
if missing_ids:
    ...
    permits_by_cwns = (
        ca_wwtp_process_extraction.drop_duplicates('CWNS_ID', keep='first')
